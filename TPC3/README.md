...
Na aula do dia **2 de Outubro**, foi atribuído um trabalho para casa: **Criar uma aplicação para manipulação de listas de inteiros**. Aqui está a minha resolução do mesmo.
